...
RUN apt-get update && apt-get install -y libxml2 libgio-cil kmod libgtk-3-0 x11vnc xvfb net-tools '^libwebkit2gtk-4.0-[0-9]+$' blackbox iproute2 iptables busybox-syslogd novnc dante-server inetutils-ping && apt-get clean
